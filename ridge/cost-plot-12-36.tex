...
\begin{tikzpicture}
  \begin{axis}[
    ...
    % J(theta) = (1/2) * [(theta - 3)^2 + (2*theta - 6)^2]
    % Expanded: J(theta) = (1/2) * [5*theta^2 - 30*theta + 45]
    % Minimum at theta* = 30/(2*5) = 3
    \addplot[domain=0:5, samples=200, ultra thick, color=mycolor]
      {(1/2) * (5*x^2 - 30*x + 45)};
  \end{axis}
\end{tikzpicture}
\end{document}
