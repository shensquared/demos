...
\begin{tikzpicture}
  \begin{axis}[
    ...
    % Slope label
    \node[green!80!black, font=\small, anchor=north east, align=left] at (axis cs:4.0,2.5)
      {slope $= \frac{1}{3}(\textcolor{brown}{0}+\textcolor{blue}{9}+\textcolor{gray}{24})$\\$\phantom{\text{slope}} = 11$};

    % Label the curve
    \node[gold!80!black, font=\small, anchor=north east] at (axis cs:3.05,20)
      {\(J = \frac{1}{3}(\textcolor{brown}{J_1}\!+\!\textcolor{blue}{J_2}\!+\!\textcolor{gray}{J_3})\)};
  \end{axis}
  \pgfresetboundingbox
